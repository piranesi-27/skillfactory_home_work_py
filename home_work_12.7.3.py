...
deposit = [int(money / 100 * values[0]), int(money / 100 * values[1]), int(money / 100 * values[2]), int(money / 100 * values[3])] #рассчитываем депозит обращаясь к индексу ставки из списка, отбрасываем дробную часть и оборачиваем в список
